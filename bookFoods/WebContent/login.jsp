		...
		<div class="container">
			<div class="account_grid">
				<div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
					<h3>新顾客</h3>
					<p>通过在我们的商店创建帐户，你将能够通过结帐过程更快地移动存储多个送货地址、 查看和跟踪您在您的帐户和更多的订单。.</p>
					<a class="acount-btn" href="register.jsp">创建新帐号</a>
			   </div>
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
					...
					<form action="./LoginServlet" method="post">
						...
						<a class="forgot" href="#">忘记密码?</a><br><br>
						<input type="submit" value="登录" style="width:150px;margin-left:30%" >
	...
	<div class="footer">
		<div class="container">
			<div class="footer-left">
				<p>Copyrights © 2015 SpiceMystery All rights reserved | Design by <a href="http://w3layouts.com/">Android一班第五组</a></p>
			</div>
			>	
				<div class="clearfix"></div>
		</div>
